...
TOOLCHAIN_ARM32=/home/ankur/Documents/testgit/test/toolchains/aarch32/bin
TOOLCHAIN_ARM64=/home/ankur/Documents/testgit/test/toolchains/aarch64/bin
...
sub_commands
clean_files
make PYTHON=python2 CROSS_COMPILE=${TOOLCHAIN_GCC} all --jobs=1 --trace
pack_images
finish
